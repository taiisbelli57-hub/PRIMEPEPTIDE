...
O painel suporta acessos individuais para Proprietário e Administrador. O Proprietário pode criar ou bloquear usuários e definir senhas temporárias. Cada usuário altera a própria senha. Todas as ações administrativas importantes são registradas na aba Auditoria.

Antes de publicar, configure no Render um `JWT_SECRET` longo e aleatório. Nunca envie o arquivo `.env` ao GitHub.
